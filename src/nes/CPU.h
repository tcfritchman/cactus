...
class CPU
{
 ...
 private:
	...
	bool mIsPageBoundaryCrossed = false;
	uint16_t mAddr = 0;
	uint8_t mData = 0;
	...
	bool IsExtraCycleInstruction(const Operation::Instruction instruction);
	...
	static inline std::vector<Operation> const OPERATIONS = {
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::SLO, 8},
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::NOP, 3},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::SLO, 5},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::SLO, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::SLO, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::SLO, 6},
		...
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::SLO, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::SLO, 7},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::RLA, 8},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::RLA, 5},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::RLA, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::RLA, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::RLA, 6},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::RLA, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::RLA, 7},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::SRE, 8},
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::NOP, 3},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::SRE, 5},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::SRE, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::SRE, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::SRE, 6},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::SRE, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::SRE, 7},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::RRA, 8},
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::NOP, 3},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::RRA, 5},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::RRA, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::RRA, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::RRA, 6},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::RRA, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::RRA, 7},

		// 0x80
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::STA, 6},
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::SAX, 6},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::SAX, 3},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::SAX, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_Y, Operation::Instruction::SAX, 4},
		...
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::LAX, 6},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::LAX, 3},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::LAX, 4},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::LAX, 5},
		...
		{Operation::AddressingMode::ZERO_PAGE_Y, Operation::Instruction::LAX, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::LAX, 4},
		...
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::DCP, 8},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::DCP, 5},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::DCP, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::DCP, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::DCP, 6},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::DCP, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::DCP, 7},
		...
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::ISB, 8},
		...
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::ISB, 5},
		...
		{Operation::AddressingMode::ABSOLUTE, Operation::Instruction::ISB, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::ISB, 8},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::ISB, 6},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::ISB, 7},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::ISB, 7},
	};
	...
	std::unordered_map<Operation::Instruction, std::function<void()>> const INSTRUCTION_MAP = {
		...
		{ Operation::Instruction::LAX, [this] { LAX(); } },
		{ Operation::Instruction::SAX, [this] { SAX(); } },
		{ Operation::Instruction::DCP, [this] { DCP(); } },
		{ Operation::Instruction::ISB, [this] { ISB(); } },
		{ Operation::Instruction::SLO, [this] { SLO(); } },
		{ Operation::Instruction::RLA, [this] { RLA(); } },
		{ Operation::Instruction::SRE, [this] { SRE(); } },
		{ Operation::Instruction::RRA, [this] { RRA(); } }
	};
