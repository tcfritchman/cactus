...
class CPU
{
 ...
 private:
	...
	static inline std::vector<Operation> const OPERATIONS = {
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::SLO, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::SLO, 5},
		...
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::SLO, 4},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::RLA, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::RLA, 5},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::RLA, 4},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::SRE, 6},
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::NOP, 3},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::SRE, 5},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::SRE, 4},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::RRA, 6},
		{Operation::AddressingMode::ZERO_PAGE, Operation::Instruction::NOP, 3},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::RRA, 5},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::RRA, 4},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::DCP, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::DCP, 5},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::DCP, 4},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMMEDIATE, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::INDEXED_INDIRECT, Operation::Instruction::ISB, 6},
		...
		UNKNOWN_INSTR,
		{Operation::AddressingMode::INDIRECT_INDEXED, Operation::Instruction::ISB, 5},
		{Operation::AddressingMode::ZERO_PAGE_X, Operation::Instruction::NOP, 4},
		...
		{Operation::AddressingMode::IMPLICIT, Operation::Instruction::NOP, 2},
		{Operation::AddressingMode::ABSOLUTE_Y, Operation::Instruction::ISB, 4},
		{Operation::AddressingMode::ABSOLUTE_X, Operation::Instruction::NOP, 4},
